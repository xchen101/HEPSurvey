...
p1 <- ggplot(F1, aes(x = `p5q2 [1]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F2 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by (D3, `p5q2 [2]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p2 <- ggplot(F2, aes(x = `p5q2 [2]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F3 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by(D3, `p5q2 [3]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p3 <- ggplot(F3, aes(x = `p5q2 [3]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F4 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by(D3, `p5q2 [4]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p4 <- ggplot(F4, aes(x = `p5q2 [4]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F5 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by(D3, `p5q2 [5]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p5 <- ggplot(F5, aes(x = `p5q2 [5]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F6 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by(D3, `p5q2 [6]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p6 <- ggplot(F6, aes(x = `p5q2 [6]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F7 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by(D3, `p5q2 [7]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p7 <- ggplot(F7, aes(x = `p5q2 [7]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F8 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by(D3, `p5q2 [8]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p8 <- ggplot(F8, aes(x = `p5q2 [8]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
...
F9 <- coded_data %>% #<- change
  filter(!is.na(Sex)) %>%
  group_by(D3, `p5q2 [9]`) %>% #<- change  
  summarize(count = n()) %>%
  mutate(freq = count / sum(count))

p9 <- ggplot(F9, aes(x = `p5q2 [9]`, y = freq, color = D3)) + # <- change
  geom_line() +
  geom_point() +
